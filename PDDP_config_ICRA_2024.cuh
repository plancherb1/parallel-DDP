...
#define STATE_REG 1 // use Tassa state regularization (0 indicates standard Huu regularization)
	...
	#define RHO_INIT 1.0
#endif
#define RHO_MAX_PDDP 10000000.0 //100000.0
#define RHO_MIN_PDDP 0.01 // 0.000001
...
// Matrix Dimms
#define DIM_x_r STATE_SIZE_PDDP
#define DIM_x_c 1
#define DIM_u_r CONTROL_SIZE
#define DIM_u_c 1
#define DIM_d_r STATE_SIZE_PDDP
#define DIM_d_c 1
#define DIM_AB_r STATE_SIZE_PDDP
#define DIM_AB_c (STATE_SIZE_PDDP + CONTROL_SIZE)
#define DIM_ABT_r (STATE_SIZE_PDDP + CONTROL_SIZE)
#define DIM_ABT_c STATE_SIZE_PDDP
#define DIM_A_r STATE_SIZE_PDDP
#define DIM_A_c STATE_SIZE_PDDP
#define DIM_H_r (STATE_SIZE_PDDP + CONTROL_SIZE)
#define DIM_H_c (STATE_SIZE_PDDP + CONTROL_SIZE)
#define DIM_Hxx_r STATE_SIZE_PDDP
#define DIM_Hxx_c STATE_SIZE_PDDP
#define DIM_Hux_r CONTROL_SIZE
#define DIM_Hux_c STATE_SIZE_PDDP
#define DIM_Hxu_r STATE_SIZE_PDDP
#define DIM_Hxu_c CONTROL_SIZE
#define DIM_Huu_r CONTROL_SIZE
#define DIM_Huu_c CONTROL_SIZE
#define DIM_g_r (STATE_SIZE_PDDP + CONTROL_SIZE)
#define DIM_g_c 1
#define DIM_gx_r STATE_SIZE_PDDP
#define DIM_gx_c 1
#define DIM_gu_r CONTROL_SIZE
#define DIM_gu_c 1
#define DIM_P_r STATE_SIZE_PDDP
#define DIM_P_c STATE_SIZE_PDDP
#define DIM_p_r STATE_SIZE_PDDP
#define DIM_p_c 1
#define DIM_K_r CONTROL_SIZE
#define DIM_K_c STATE_SIZE_PDDP
